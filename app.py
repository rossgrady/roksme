from parsers import rhp_parser, tribe_parser, tickera_parser, ical_parser
...
venues_list = [{'name':"Cat's Cradle", 'url':'https://catscradle.com/events/?view=list', 'parser':rhp_parser}, {'name': "Local 506", 'url':'https://local506.com/events/?view=list', 'parser':rhp_parser}, {'name':"The Pinhook", 'url':'https://thepinhook.com/events/?view=list', 'parser':rhp_parser}, {'name':"Slim's", 'url':'https://slimsraleigh.com/calendar/list/', 'parser': tribe_parser},{'name':"The Cave", 'url':'https://caverntavern.com/calendar/list/', 'parser': tribe_parser}, {'name':"Motorco", 'url':'https://motorcomusic.com/', 'parser': tickera_parser}]
